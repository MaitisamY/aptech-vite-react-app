...
export default function ClassData(props) {
    ...
    const filteredClasses = classes.filter(classDt =>
        classDt.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
        classDt.status.toLowerCase().includes(searchQuery.toLowerCase())
    );
                            ...
                            <tr key={classesBar.id}>
                                ...
                                <td>
                                    {classesBarData.filter(bar => bar.labelText === classesBar.name).map((bar) => (
                                        <Div key={bar.id} title={bar.barText}>{bar.barText}</Div>
                                    ))}
                                </td>
                                <td>
