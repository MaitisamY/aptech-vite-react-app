...
export default function AdministratorsData(props) {
    ...
    const adminisSliced = filteredAdministrators.slice(start, end);
    ...
    const pageNumbers = Array.from({ length: Math.ceil(administrators.length / perPage) }, (_, index) => index + 1);
        ...
        <>
            <Div style={{ display: "flex", width: "96%", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
                <SearchDatatables
                    ...
                    autoComplete="off"
                />
                <span style={{ marginLeft: "10px" }}><strong>Total Admins: {administrators.length}</strong></span>
            </Div>
            ...
            <Div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "20px"}}>
                {pageNumbers.length > 1 && filteredAdministrators.length > 0 && (
                    <>
                        <Div>
                            <PaginationButton 
                        ...
                        <p>Showing {start + 1} to {end} of {filteredAdministrators.length} entries</p>
                    </>
                )}
            </Div>
        </>
