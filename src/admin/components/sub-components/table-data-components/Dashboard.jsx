                    ...
                    <tr key={bar.id}>
                        ...
                        <td>
                            <Div 
                                ...
                                style={{width: bar.barText, textAlign: "right" }}>
                                {bar.barText}
                            </Div>
                        </td>
                    </tr>
                    ...
                    <tr key={studentBar.id}>
                        ...
                        <td>
                            <Div 
                                ...
                                className={studentBar.barClass} 
                                style={{ width: studentBar.barText, textAlign: "right" }}>
                                {studentBar.barText}
                            </Div>
                        </td>
                    </tr>
                    ...
                    <tr key={classesBar.id}>
                        ...
                        <td>
                            <Div
                                ...
                                className={classesBar.barClass} 
                                style={{ width: classesBar.barText, textAlign: "right" }}>
                                {classesBar.barText}
                            </Div>
                        </td>
                    </tr>
